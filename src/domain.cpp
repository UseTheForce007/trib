...
Domain::Domain(double xin, double xout, uint64_t nx, double yin, double yout, uint64_t ny, uint64_t mgl, std::string typeX, std::string typeY)
    : mgl(mgl), nx(nx), ny(ny), xin(xin), xout(xout), yin(yin), yout(yout), typeX(typeX), typeY(typeY)
{
