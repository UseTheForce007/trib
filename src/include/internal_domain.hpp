...
namespace internal
{
    ...
    public:
        Domain();
        Domain(std::string type, std::vector<double> dx, std::vector<double> dy, std::vector<double> x, std::vector<double> y, std::vector<std::vector<double>> &vec_x, std::vector<std::vector<double>> &vec_y, uint64_t nx, uint64_t ny);
